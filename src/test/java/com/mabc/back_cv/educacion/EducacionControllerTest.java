...
class EducacionControllerTest {
    ...
    void setUp() {
        ...
        educacionPage = new PageImpl<>(Arrays.asList(educacionDTO));
    ...
    @Disabled("Jackson no puede serializar Page con standaloneSetup")
    @Test
    ...
    void getAll_conPaginaVacia_retorna200() throws Exception {
        ...
        Page<EducacionDTO> paginaVacia = new PageImpl<>(Collections.emptyList());
