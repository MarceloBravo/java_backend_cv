...
class EducacionControllerTest {
    ...
    void setUp() {
        ...
        educacionDTO.setUsuario(null); // Usuario null para evitar problemas de deserialización en tests

        educacionPage = new PageImpl<>(Arrays.asList(educacionDTO), PageRequest.of(0, 10), 1);
    }
    ...
    void getAll_sinParametros_retorna200() throws Exception {
        when(educacionService.findBySearchText(any(), any(), any(), any()))
                .thenReturn(educacionPage);
    ...
    @Test
    void getAll_conPaginaVacia_retorna200() throws Exception {
    ...
    @Test
    void getAllByUserId_conPageNegativo_retorna200() throws Exception {
        when(educacionService.findByUserId(anyLong(), any(), any()))
                .thenReturn(educacionPage);
    ...
    @Test
    void getAllByUserId_conSizeCero_retorna200() throws Exception {
        when(educacionService.findByUserId(anyLong(), any(), any()))
                .thenReturn(educacionPage);
    ...
    @Test
    void getAllByUserId_conSizeNegativo_retorna200() throws Exception {
        when(educacionService.findByUserId(anyLong(), any(), any()))
                .thenReturn(educacionPage);
    ...
    void save_conDTOConIdNull_retorna200() throws Exception {
        ...
        educacionGuardada.setUsuario(usuario);
    ...
    void save_conDTOSinCamposObligatorios_retorna500() throws Exception {
        ...
        dtoIncompleto.setUsuario(usuario);
